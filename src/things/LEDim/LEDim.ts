...
import { Config, RegisterType, RegisterData } from '~classes/Modbus/types';
import { Entity } from '~classes/Entity';
import { Color, OnOff } from '~classes/types';

type TColor = OnOff & Color;
...
class Channel extends Entity<LEDim, TColor> {
